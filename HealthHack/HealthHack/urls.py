...
from HealthHack.views import home, about, contact, company, searchList, submittedContact
...
urlpatterns = [
    ...
    path('submitted/', submittedContact.submittedContact, name = "submitted contact"),
